...
import ChatWidget from '@/components/ui/ChatWidget'; // Import the chat widget
...
export default function DashboardPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-gray-900 dark:to-gray-950">
      ...
      {/* Chat Widget - Floating button that appears on all pages */}
      {user && user.id && <ChatWidget userId={user.id} />}
    </div>
  );
}
